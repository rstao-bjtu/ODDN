...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--adv_warmup', type=int, default=3)
        parser.add_argument('--warming_up', type=int, default=3)

        parser.add_argument('--delr_freq', type=int, default=10, help='delr_freq')
